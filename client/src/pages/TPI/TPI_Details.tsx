...
const TPI_Details = () => {
  ...
  //////////////////////////////////////////////////////
  const [tpiInfoOpenModal, setTpiInfoOpenModal] = useState(false);
  ...
  ////////// Add TPI Value Modal   /////////////////////
  //////////////////////////////////////////////////////
  const [openTpiValueModal, setOpenTpiValueModal] = useState(false);
  ...
  const [tpiValueType, setTpiValueType] = useState("TPI_VALUE");
  ...
  const [tpiInfoMessage, setTpiInfoMessage] = useState("");
  const [tpiInfoIssues, setTpiInfoIssues] = useState("");
