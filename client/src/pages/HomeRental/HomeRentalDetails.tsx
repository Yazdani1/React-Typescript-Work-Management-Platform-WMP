...
const HomeRentalDetails = () => {
  ...
  const [singleHomeRental, setSingleHomeRental] = useState<HomeRentalItems | any>(null);
          ...
          <div className={style.allImageListDesign}>
            {singleHomeRental?.photo.map((p: any, index: number) => (
              <div
                ...
                className={currentImage === index ? style.selectedImageDesign : style.imagePreviewList}
